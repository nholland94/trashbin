...
(* OASIS_START *)
(* DO NOT EDIT (digest: 7df6b4ba49a05143f38cd7146719038c) *)
(*
...
let setup_t =
  {
     ...
     package =
       {
          ...
          homepage = None;
          synopsis = "Provides a customizable personal jira burndown";
          description =
            Some
              [
                 OASISText.Para
                   "Jira burndown allows you to create a personal burndown from a board an queue up tasks."
              ];
          categories = [];
     ...
     oasis_version = "0.4.5";
     oasis_digest = Some "\224>\151\169L\211O\030Cv\169H\168\012b)";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
